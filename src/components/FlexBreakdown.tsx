...
function Sparkline({ color }: { color: string }) {
  ...
  return (
    <div className="sparkline-container">
      <svg width="100%" height="35" viewBox="0 0 150 50" preserveAspectRatio="none">
        <defs>
  ...
  return (
    <div className="relative bg-rc-card rounded-xl border border-rc-border p-3 sm:p-5 hover:border-rc-borderLight transition-all duration-200 animate-fade-in overflow-hidden">
      <div className="flex items-start justify-between mb-0.5">
        <span className="text-xs font-medium text-rc-textMuted">
          {title}
        </span>
        <Info className="w-3 h-3 text-rc-textDim cursor-help" />
      </div>
      ...
      <p className="text-xs text-rc-textDim mb-1">
